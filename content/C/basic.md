...
# Какое значение вернет выражение `8 % 14` в языке Си?
- [ ] 2
- [x] 6
- [ ] 1
- [ ] 0.57
...
## :desc
Выражение `8 % 14` в языке Си вернет значение `6`, поскольку `%` - оператор взятия остатка от целочисленного деления. `14` делится без остатка на `8` только 1 раз, а остатком будет `6`.
