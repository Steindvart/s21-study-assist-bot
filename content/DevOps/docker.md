...
- `RUN`: Выполняет команды в процессе сборки образа, например, такие как установка программного обеспечения.
...
# Какой командой можно создать новый контейнер из образа в Docker и сразу его запустить?
- [ ] `docker build`
- [ ] `docker create`
- [x] `docker run`
- [ ] `docker start`
